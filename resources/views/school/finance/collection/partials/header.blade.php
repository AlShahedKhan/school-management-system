<div class="bg-white border border-gray-200 p-2.5 sm:p-4 mb-2" style="border-radius:0;">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        @include('school.finance.collection.partials.search-desktop')
        @include('school.finance.collection.partials.export')
    </div>
    @include('school.finance.collection.partials.search-mobile')
</div>