<div class="bg-white border border-gray-200 p-2.5 sm:p-4 mb-2" style="border-radius:0;">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        <div class="hidden lg:flex items-center gap-2">
            <x-input.search id="examSearch" placeholder="Search Exam..." class="w-full lg:block lg:w-72" />
        ...
        <div class="grid w-full grid-cols-3 gap-2 lg:flex lg:w-auto">
            ...
            <x-button.primary id="openExamModalBtn" class="flex-1 lg:flex-none" onclick="openExamModal()">Add Exam</x-button.primary>
        </div>
    </div>
    <div class="mt-3 grid grid-cols-3 gap-2 lg:hidden">
        <x-input.search id="examSearchMobile" placeholder="Search Exam..." class="col-span-2 min-w-0" />
