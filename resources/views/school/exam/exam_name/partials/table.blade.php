<style>
    ...
    .donate-fixed-table { width: 100%; min-width: 1060px; table-layout: fixed; }
    ...
    @media (min-width: 1024px) { .donate-fixed-table { width: 100%; min-width: 1060px; } .donate-table-scroll { overflow-x: auto; } }
    @media (max-width: 1023px) { .donate-fixed-table { width: 1060px; min-width: 1060px; } }
...
<x-table
    unstyled :empty="false" empty-message="No exam names found."
    ...
    head-class="bg-gray-100" tbody-class="" tbody-id="examTableBody"
    class="bg-white border border-gray-200 p-2.5 sm:p-4 mb-0 shadow-md" style="border-radius:0;"
>
    <x-slot:columns>
        <colgroup>
            <col style="width: 5%;"><col style="width: 13%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 18%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 8%;">
        </colgroup>
    </x-slot:columns>
    <x-slot:head>
    ...
    <x-slot:body>
        <tr>
            <td colspan="9" class="border border-gray-300 px-3 py-10 text-center text-gray-500">Loading...</td>
        </tr>
    </x-slot:body>
    <x-slot:footer>
