...
<div class="fp-page">
    <div class="fp-header">
        <div>
            ...
            <h1 class="fp-title">Teacher Attendance</h1>
            <p class="fp-subtitle">Track teacher fingerprint in/out time, late minutes and daily attendance status.</p>
        </div>
...
<div class="fp-summary">
    ...
    <div class="fp-card">
        <div class="fp-card-head">
            <div><h4><i class="fas fa-filter" style="color:#2563eb;margin-right:7px"></i>Attendance Filter</h4><p>Filter by Teacher, Month and Year.</p></div>
        </div>
        <div class="fp-card-body">
            <div class="fp-filter-grid">
                <div class="col-6">
                    <label class="fp-label">Teacher</label>
                    <select class="fp-select">
                        <option>All Teachers</option>
                        <option>Abdul Hasan — T-1001</option>
                        <option>Sumaiya Rahman — T-1002</option>
                        <option>Mahmud Karim — T-1003</option>
                    </select>
                </div>
                <div class="col-2">
    ...
    <div class="fp-card">
        <div class="fp-card-head">
            <div><h4><i class="fas fa-fingerprint" style="color:#2563eb;margin-right:7px"></i>Teacher Attendance Report</h4><p>Fingerprint attendance report for selected period.</p></div>
            <div class="fp-search"><i class="fas fa-search"></i><input id="fpAttendanceSearch" type="text" placeholder="Search teacher or status..."></div>
        </div>
        <div class="fp-table-wrap">
            <table class="fp-table" id="fpAttendanceTable">
                <thead>
                    <tr><th>SL</th><th>Date</th><th>Teacher Name</th><th>ID Number</th><th>Designation</th><th>In Time</th><th>Late Minutes</th><th>Out Time</th><th>Status</th></tr>
                </thead>
                <tbody>
                    <tr><td>01</td><td>01 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">AH</div><div><b>Abdul Hasan</b><small>Teacher</small></div></div></td><td>T-1001</td><td>Senior Teacher</td><td>07:55 AM</td><td>0 min</td><td>03:05 PM</td><td><span class="fp-status present">Present</span></td></tr>
                    <tr><td>02</td><td>02 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">SR</div><div><b>Sumaiya Rahman</b><small>Teacher</small></div></div></td><td>T-1002</td><td>Assistant Teacher</td><td>08:22 AM</td><td><span class="late-min">7 min</span></td><td>03:10 PM</td><td><span class="fp-status late">Late</span></td></tr>
                    <tr><td>03</td><td>03 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">MK</div><div><b>Mahmud Karim</b><small>Teacher</small></div></div></td><td>T-1003</td><td>Teacher</td><td>—</td><td>—</td><td>—</td><td><span class="fp-status absent">Absent</span></td></tr>
                    <tr><td>04</td><td>04 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">AH</div><div><b>Abdul Hasan</b><small>Teacher</small></div></div></td><td>T-1001</td><td>Senior Teacher</td><td>—</td><td>—</td><td>—</td><td><span class="fp-status leave">Leave</span></td></tr>
                    <tr><td>05</td><td>05 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">SR</div><div><b>Sumaiya Rahman</b><small>Teacher</small></div></div></td><td>T-1002</td><td>Assistant Teacher</td><td>—</td><td>—</td><td>—</td><td><span class="fp-status holiday">Holiday</span></td></tr>
                </tbody>
            </table>
        </div>
