    ...
    <div class="max-w-full mx-auto w-full">
        ...
        <div class="mb-3 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <div class="mt-1 flex items-center gap-2 text-[10px] text-slate-400">
                    ...
                    <span class="font-semibold text-slate-600">Employee Attendance</span>
                </div>
                <h1 class="mt-1 text-[18px] font-black text-slate-900">Employee Attendance</h1>
                <p class="mt-1 text-[10px] text-slate-500">Monitor employee fingerprint attendance records.</p>
            </div>
        ...
        <div class="fp-shell">
            <div class="border-b border-slate-200 px-3 py-2">
                <div class="text-[11px] font-black uppercase tracking-wider text-slate-700">Employee Attendance</div>
            </div>
        ...
        <div class="xl:col-span-6">
            <label class="mb-1 block text-[9px] font-black uppercase tracking-widest text-slate-500">Employee</label>
            <select data-fp-filter class="fp-filter-select"><option>All Employees</option><option>Jahidul Islam — E-2001</option><option>Nusrat Jahan — E-2002</option><option>Rafiq Ahmed — E-2003</option></select>
        </div>
        ...
        <div class="fp-table-scroll">
            <table id="fpAttendanceTable" class="w-full border-collapse">
                <thead><tr><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">SL</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Date</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Employee</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Mobile</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Designation</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">In Time</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Late Minutes</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Out Time</th><th class="h-8 whitespace-nowrap border border-slate-300 bg-slate-100 px-3 text-left text-[9px] font-black uppercase tracking-wide text-slate-500">Status</th></tr></thead>
        ...
        <div class="flex items-center gap-2">
            <div class="flex h-7 w-7 items-center justify-center rounded bg-slate-100 text-[9px] font-black text-slate-600">JI</div>
            <div>
                <div class="text-[10px] font-bold text-slate-800">Jahidul Islam</div>
                <div class="text-[8px] text-slate-400">E-2001</div>
            </div>
        </div>
    </td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">01700-000001</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">Accountant</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">08:50 AM</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">0 min</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">05:06 PM</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 "><span class="fp-status-badge present">Present</span></td></tr><tr data-status="late"><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">02</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">02-August-2026</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">
        <div class="flex items-center gap-2">
            <div class="flex h-7 w-7 items-center justify-center rounded bg-slate-100 text-[9px] font-black text-slate-600">NJ</div>
            <div>
                <div class="text-[10px] font-bold text-slate-800">Nusrat Jahan</div>
                <div class="text-[8px] text-slate-400">E-2002</div>
            </div>
        </div>
    </td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">01700-000002</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">Office Executive</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">09:14 AM</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 "><span class="font-bold text-orange-600">14 min</span></td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">05:03 PM</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 "><span class="fp-status-badge late">Late</span></td></tr><tr data-status="leave"><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">03</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">03-August-2026</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">
        <div class="flex items-center gap-2">
            <div class="flex h-7 w-7 items-center justify-center rounded bg-slate-100 text-[9px] font-black text-slate-600">RA</div>
            <div>
                <div class="text-[10px] font-bold text-slate-800">Rafiq Ahmed</div>
                <div class="text-[8px] text-slate-400">E-2003</div>
            </div>
        </div>
    </td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">01700-000003</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">Security Officer</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">-</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">-</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 ">-</td><td class="h-9 whitespace-nowrap border border-slate-300 px-3 text-[10px] text-slate-700 "><span class="fp-status-badge leave">Leave</span></td></tr>
                </tbody>
            </table>
        </div>
