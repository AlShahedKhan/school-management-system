...
<div class="fp-page">
    <div class="fp-header">
        <div>
            ...
            <h1 class="fp-title">Employee Attendance</h1>
            <p class="fp-subtitle">Track employee fingerprint in/out time, late minutes and daily attendance status.</p>
        </div>
...
<div class="fp-summary">
    ...
    <div class="fp-card">
        <div class="fp-card-head">
            <div><h4><i class="fas fa-filter" style="color:#2563eb;margin-right:7px"></i>Attendance Filter</h4><p>Filter by Employee, Month and Year.</p></div>
        </div>
        <div class="fp-card-body">
            <div class="fp-filter-grid">
                <div class="col-6">
                    <label class="fp-label">Employee</label>
                    <select class="fp-select">
                        <option>All Employees</option>
                        <option>Jahidul Islam — E-2001</option>
                        <option>Nusrat Jahan — E-2002</option>
                        <option>Rafiq Ahmed — E-2003</option>
                    </select>
                </div>
                <div class="col-2">
                    <label class="fp-label">Month</label>
                    <select class="fp-select"><option>August</option><option>July</option><option>June</option></select>
                </div>
                <div class="col-2">
                    <label class="fp-label">Year</label>
                    <select class="fp-select"><option>2026</option><option>2025</option></select>
                </div>
                <div class="col-2">
                    <button type="button" id="fpFilterButton" class="fp-btn"><i class="fas fa-search" style="margin-right:5px"></i>Filter</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="fp-card">
        <div class="fp-card-head">
            <div><h4><i class="fas fa-fingerprint" style="color:#2563eb;margin-right:7px"></i>Employee Attendance Report</h4><p>Fingerprint attendance report for selected period.</p></div>
            <div class="fp-search"><i class="fas fa-search"></i><input id="fpAttendanceSearch" type="text" placeholder="Search employee or status..."></div>
        </div>
        <div class="fp-table-wrap">
            <table class="fp-table" id="fpAttendanceTable">
                <thead>
                    <tr><th>SL</th><th>Date</th><th>Employee</th><th>Mobile</th><th>Designation</th><th>In Time</th><th>Late Minutes</th><th>Out Time</th><th>Status</th></tr>
                </thead>
                <tbody>
                    <tr><td>01</td><td>01 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">JI</div><div><b>Jahidul Islam</b><small>E-2001</small></div></div></td><td>01700-000001</td><td>Accountant</td><td>08:50 AM</td><td>0 min</td><td>05:06 PM</td><td><span class="fp-status present">Present</span></td></tr>
                    <tr><td>02</td><td>02 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">NJ</div><div><b>Nusrat Jahan</b><small>E-2002</small></div></div></td><td>01700-000002</td><td>Office Executive</td><td>09:14 AM</td><td><span class="late-min">14 min</span></td><td>05:03 PM</td><td><span class="fp-status late">Late</span></td></tr>
                    <tr><td>03</td><td>03 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">RA</div><div><b>Rafiq Ahmed</b><small>E-2003</small></div></div></td><td>01700-000003</td><td>Security Officer</td><td>—</td><td>—</td><td>—</td><td><span class="fp-status absent">Absent</span></td></tr>
                    <tr><td>04</td><td>04 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">JI</div><div><b>Jahidul Islam</b><small>E-2001</small></div></div></td><td>01700-000001</td><td>Accountant</td><td>—</td><td>—</td><td>—</td><td><span class="fp-status leave">Leave</span></td></tr>
                    <tr><td>05</td><td>05 Aug 2026</td><td><div class="fp-person"><div class="fp-avatar">NJ</div><div><b>Nusrat Jahan</b><small>E-2002</small></div></div></td><td>01700-000002</td><td>Office Executive</td><td>—</td><td>—</td><td>—</td><td><span class="fp-status holiday">Holiday</span></td></tr>
                </tbody>
            </table>
        </div>
