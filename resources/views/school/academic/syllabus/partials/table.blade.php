...
<x-table
    unstyled :empty="false" empty-message="No syllabuses found."
    ...
    head-class="bg-gray-100" tbody-class="" tbody-id="syllabusTableBody"
    class="bg-white border border-gray-200 p-2.5 sm:p-4 mb-0 shadow-md" style="border-radius:0;"
>
    <x-slot:columns>
        <colgroup>
            <col style="width: 4%;"><col style="width: 10%;"><col style="width: 8%;"><col style="width: 8%;"><col style="width: 10%;"><col style="width: 14%;"><col style="width: 14%;"><col style="width: 10%;"><col style="width: 10%;"><col style="width: 10%;">
        </colgroup>
    </x-slot:columns>
    <x-slot:head>
