...
<x-table
    unstyled :empty="false" empty-message="No fee templates configured."
...
>
    <x-slot:columns>
        <colgroup>
            <col style="width: 4%;"><col style="width: 14%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 12%;"><col style="width: 10%;"><col style="width: 10%;"><col style="width: 8%;">
        </colgroup>
    </x-slot:columns>
    <x-slot:head>
