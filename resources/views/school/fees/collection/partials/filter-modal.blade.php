...
>
    <x-input.dropdown-select
        ...
        add-button-id="openClassFromCollectionFilter"
    ...
    <x-input.dropdown-select
        ...
        add-button-id="openGroupFromCollectionFilter"
    ...
    <x-input.dropdown-select
        ...
        add-button-id="openSectionFromCollectionFilter"
    ...
    <x-input.dropdown-select
        ...
        add-button-id="openSessionFromCollectionFilter"
