                        ...
                        <tr id="device-row-{{ $device->id }}">
                            <td>
                                <div class="device-name">
                                    <div class="device-avatar"><i class="bi bi-fingerprint"></i></div>
                                    <div>
                            ...
                            <td>
                                @if ($device->communication_type === 'WiFi')
                                    <i class="bi bi-wifi me-1"></i>
                                @else
                                    <i class="bi bi-router me-1"></i>
                                @endif
                                {{ $device->communication_type ?? 'LAN' }}
                            </td>
                            <td>
                                @if ($device->status)
                            ...
                            <td>
                                ...
                                <button class="action-btn btn-edit" title="Edit" data-id="{{ $device->id }}"><i class="bi bi-pencil"></i></button>
                                <button class="action-btn action-delete btn-delete" title="Delete" data-id="{{ $device->id }}"><i class="bi bi-trash"></i></button>
                            </td>
                            {{-- ... --}}
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="text-center p-5">No devices found.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
