...
@section('title', 'Create Dashboard News')
@section('page-title', 'Create Dashboard News')
...
@section('content')
    <div class="min-h-screen bg-gray-50 p-4 md:p-6">
        <div class="mb-6 flex flex-col justify-between gap-4 border border-gray-100 bg-white p-4 shadow-sm md:flex-row md:items-center">
            <div>
                <h2 class="text-xl font-bold text-gray-800">Create Dashboard News</h2>
                <p class="text-xs text-gray-500">Add a school dashboard news message controlled by admin.</p>
            </div>
        ...
        <form action="{{ route('admin.dashboard-news.store') }}" method="POST">
            @csrf
            @php($submitLabel = 'Create News')
