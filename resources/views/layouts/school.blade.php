    ...
    <div class="flex">
        <aside id="sidebar" class="sidebar">
            <div class="sidebar-brand p-6 text-center">
                <div class="sidebar-brand-logo w-full h-20 flex items-center justify-center overflow-hidden border border-gray-300 bg-white"
                    style="border-radius: 0;">
                    <img id="sideSchoolLogo" src="{{ $schoolLogo }}" alt="Astha Academy"
                        class="w-full h-full object-contain" style="display: block;">
                </div>

                <button type="button" id="sidebarDesktopToggle" class="sidebar-desktop-toggle"
                    aria-label="Collapse sidebar" aria-controls="sidebar" aria-expanded="true">
                    <i class="fas fa-times" aria-hidden="true"></i>
                </button>

                <button type="button" id="mobileSidebarClose" class="sidebar-mobile-close" aria-label="Close sidebar">
                    <i class="fas fa-times" aria-hidden="true"></i>
                </button>
            </div>
